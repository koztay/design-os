...
Use this template to implement one section at a time. Fill in the variables below before copying to your coding agent.

## Define Section Variables

Replace these placeholders before using:

- **SECTION_NAME** = `[Human-readable name, e.g., "Map & Navigation" or "Community Reporting"]`
- **SECTION_ID** = `[Folder name in sections/, e.g., "map-and-navigation" or "community-reporting"]`
- **NN** = `[Milestone number, e.g., "02" for Map & Navigation, "03" for Community Reporting]`

### Section Reference

| Milestone | SECTION_NAME | SECTION_ID | NN |
|-----------|--------------|------------|-----|
| 2 | Map & Navigation | map-and-navigation | 02 |
| 3 | Community Reporting | community-reporting | 03 |
| 4 | Accessibility Data Management | accessibility-data-management | 04 |
| 5 | Settings & Localization | settings-and-localization-specification | 05 |

---

## Prompt (copy everything below after filling in variables)
